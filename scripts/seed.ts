...
const SEED_USER_ID = "user_2iebEldzptWqCR9NHWY6T8LV5tt"
const SEED_CATEGORIES = [
	...
	{ id: "category_7", name: "Entertainment", userId: SEED_USER_ID, plaidId: null},
...
const main = async () => {
	try {
		...
		console.error("Errrod During Seed: ", error);
		process.exit(1);
	}
}
